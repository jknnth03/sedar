    ...
    endpoints: (build) => ({
      ...
      updateStatus: build.mutation({
        query: ({ employeeId, statusEntries, formData, ...otherFields }) => {
          ...
          // Check if any field contains a file attachment
          ...
          if (hasNewFiles || hasAttachmentFile) {
            ...
            // Add direct fields (like employee_status_label, employee_status_effectivity_date, etc.)
            ...
            // Add status entries if they exist
            ...
            // No files, use regular JSON body
