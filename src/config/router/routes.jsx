...
import FormSubmission from "../../pages/approver/FormSubmission.jsx";
...
export const ROUTES = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: CONSTANT.PAGES.REQUEST.children.FORMSUBMISSION.name,
        path: CONSTANT.PAGES.REQUEST.children.FORMSUBMISSION.path,
        element: <FormSubmission />,
        handle: {
          permission: CONSTANT.PAGES.REQUEST.children.FORMSUBMISSION.name,
        },
      },
      {
