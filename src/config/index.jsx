...
export const createEnhancedModules = (dashboardData = {}) => {
  const apiCounts = dashboardData?.result?.counts || {};

  const counts = {
    pendingApprovals: apiCounts.pending_approvals || 0,
    pendingReceiving: apiCounts.pending_receiving || 0,
    rejectedReturnedSubmissions: apiCounts.rejected_returned_submissions || 0,
  };
