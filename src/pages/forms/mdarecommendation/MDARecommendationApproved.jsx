...
import MDARecommendationTable from "./MDARecommendationTable";
import MDARecommendationModal from "../../../components/modal/form/MDARecommendation/MDARecommendationModal";
import CustomTablePagination from "../../zzzreusable/CustomTablePagination";

const MDARecommendationApproved = ({ searchQuery, dateFilters, onCancel }) => {
  ...
  const {
    ...
    refetch,
    error,
  } = useGetMdaRecommendationSubmissionsQuery(apiQueryParams, {
...
export default MDARecommendationApproved;
