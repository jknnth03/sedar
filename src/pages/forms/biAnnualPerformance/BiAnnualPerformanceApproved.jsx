...
import BiAnnualPrintingDialog from "../../../components/modal/form/BiAnnualPerformanceModal/BiAnnualPrintingDialog";
import ConfirmationDialog from "../../../styles/ConfirmationDialog";
import CustomTablePagination from "../../zzzreusable/CustomTablePagination";

const BiAnnualPerformanceApproved = ({
  searchQuery,
  dateFilters,
  onCancel,
}) => {
    ...
    <FormProvider {...methods}>
      ...
      <Dialog
        ...
        <DialogContent sx={{ p: 0 }}>
          {selectedEntry && <BiAnnualPrintingDialog data={selectedEntry} />}
        </DialogContent>
      </Dialog>
...
export default BiAnnualPerformanceApproved;
