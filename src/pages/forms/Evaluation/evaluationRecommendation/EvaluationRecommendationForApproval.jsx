...
const EvaluationRecommendationForApproval = ({ searchQuery, dateFilters }) => {
  ...
  const handleUpdateEvaluation = useCallback(
    async (formattedData, mode, entryId) => {
      setModalLoading(true);
      try {
        console.log("Updating evaluation:", formattedData);
...
export default EvaluationRecommendationForApproval;
