...
const DAFormHistoryDialog = ({
  historyDialogOpen,
  onHistoryDialogClose,
  selectedDaHistory,
}) => {
  const getEmployeeName = (daForm) => {
    return daForm?.employee_name || "N/A";
  };

  const getEmployeeCode = (daForm) => {
    return daForm?.employee_code || "N/A";
  };

  const getReferenceNumber = (daForm) => {
    return daForm?.reference_number || "N/A";
  };

  const getChargingName = (daForm) => {
    return daForm?.charging_name || "N/A";
  };
  ...
  if (
    ...
    !Array.isArray(selectedDaHistory.activity_log)
  ) {
    return null;
  }
          ...
          <Box
            ...
            <Box sx={{ flex: 1, mr: 3 }}>
              ...
              <Typography
                variant="body1"
                sx={{ color: "#666", fontSize: "16px" }}>
                {getEmployeeName(selectedDaHistory)}
              </Typography>
            </Box>
            ...
            <Box sx={{ flex: 1, mr: 3 }}>
              ...
              <Typography
                variant="body1"
                sx={{ color: "#666", fontSize: "16px" }}>
                {getEmployeeCode(selectedDaHistory)}
              </Typography>
            </Box>
...
export default DAFormHistoryDialog;
