...
const DataChangeReceived = ({
  ...
  const handleCompleteSubmission = useCallback((submission) => {
    setSelectedSubmissionId(submission.id);
    setMenuAnchor({});
    setSelectedRowForMenu(null);
  ...
  const handleActionConfirm = async () => {
    ...
    try {
      if (confirmAction === "complete" && selectedSubmissionForAction) {
        enqueueSnackbar("Data change submission completed successfully!", {
          variant: "success",
          autoHideDuration: 2000,
        });
        refetch();
  ...
  const getConfirmationMessage = useCallback(() => {
    if (confirmAction === "complete") {
      return (
        <>
          Are you sure you want to <strong>Complete</strong> this Data Change
          Request?
        </>
      );
  ...
  const getConfirmationIcon = useCallback(() => {
    ...
    const config = iconConfig[confirmAction] || iconConfig.complete;
    return config;
  }, [confirmAction]);
      ...
      <Box
        ...
        <Box
          ...
          <DataChangeForapprovalTable
            ...
            handleCompleteSubmission={handleCompleteSubmission}
...
export default DataChangeReceived;
