...
import MrfCancelledTable from "./MrfCancelledTable";
...
const MrfCancelled = () => {
  ...
  const queryParams = useMemo(() => {
    const params = {
      ...
      status: "active",
      pagination: true,
      approval_status: ["cancelled"], // Changed to show only "for receiving" status
    };
  ...
  const canResubmitSubmission = useCallback((submission) => {
    ...
    // Updated to include "FOR RECEIVING" status if resubmission is allowed
  ...
  const canEditSubmission = useCallback((submission) => {
    ...
    // Updated to include "FOR RECEIVING" status if editing is allowed
  ...
  const canCancelSubmission = useCallback((submission) => {
    ...
    // Updated to include "FOR RECEIVING" status if cancellation is allowed
