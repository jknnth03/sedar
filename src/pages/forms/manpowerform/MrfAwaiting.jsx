...
import MrfAwaitingTable from "./MrfAwaitingTable";
...
const MrfAwaiting = () => {
  ...
  const queryParams = useMemo(() => {
    const params = {
      ...
      status: "active",
      pagination: true,
      approval_status: ["awaiting_resubmission"], // Show only "awaiting_resubmission" status
    };
  ...
  const canResubmitSubmission = useCallback((submission) => {
    ...
    // For awaiting resubmission status, resubmit should be allowed
  ...
  const canEditSubmission = useCallback((submission) => {
    ...
    // For awaiting resubmission status, edit should be allowed
    const editableStatuses = ["AWAITING RESUBMISSION", "REJECTED", "RETURNED"];
  ...
  const canCancelSubmission = useCallback((submission) => {
    ...
    // For awaiting resubmission status, cancel should be allowed
