...
const CustomSearchBar = ({
  ...
  return (
    <Box
      ...
      <TextField
        placeholder={isVerySmall ? "Search..." : "Search schedules..."}
        value={searchQuery}
...
const Schedule = () => {
  ...
  const {
    ...
    refetch,
    error,
  } = useGetShowSchedulesQuery(queryParams, {
  ...
  const handleMenuOpen = useCallback((event, schedule) => {
    ...
    setMenuAnchor((prev) => ({ ...prev, [schedule.id]: event.currentTarget }));
  }, []);

  const handleMenuClose = useCallback((scheduleId) => {
  ...
  const renderStatusChip = useCallback((schedule) => {
    const isActive = !schedule.deleted_at;
                  ...
                  schedules.map((schedule) => (
                    <TableRow
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={schedule.code} placement="top">
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={schedule.name} placement="top">
                          <span style={styles.cellContentStyles}>
                            {schedule.name}
                          </span>
                        </Tooltip>
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          <MenuItem
                            onClick={(e) =>
                              handleArchiveRestoreClick(schedule, e)
                            }>
                            {schedule.deleted_at ? (
                              <>
