              ...
              <TableBody>
                {isLoadingState ? (
                  ...
                  restDays.map((restDay) => (
                    <TableRow key={restDay.id} sx={styles.tableRowHover(theme)}>
                      <TableCell align="left">{restDay.id}</TableCell>
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={restDay.code} placement="top">
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={restDay.name} placement="top">
                          <span style={styles.cellContentStyles}>
                            {restDay.name}
                          </span>
                        </Tooltip>
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          {!restDay.deleted_at && (
                            <MenuItem onClick={() => handleEditClick(restDay)}>
                          ...
                          <MenuItem
                            onClick={(e) =>
                              handleArchiveRestoreClick(restDay, e)
                            }>
                            {restDay.deleted_at ? (
                              <>
                  ...
                  <TableRow
                    ...
                    <TableCell
                      ...
                      <NoDataFound
                        ...
                        subMessage={
                          searchQuery
                            ? `No rest days found for "${searchQuery}"`
