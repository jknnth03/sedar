...
const SeparationTypes = () => {
  ...
  const separationTypeList = useMemo(
    () => separationTypes?.result?.data || [],
    [separationTypes]
  );
      ...
      <Box
        ...
        <TableContainer
          ...
          <Table stickyHeader>
            ...
            <TableBody>
              ...
              ) : separationTypeList.length > 0 ? (
                separationTypeList.map((separationType) => (
                  <TableRow key={separationType.id}>
                    ...
                    <TableCell align="center">
                      ...
                      <Menu
                        ...
                        <MenuItem
                          ...
                          sx={{
                            fontSize: "0.875rem",
                            color: separationType.deleted_at
        ...
        <Box
          ...
          <TablePagination
            ...
            component="div"
            count={separationTypes?.result?.total || 0}
