            ...
            <Table stickyHeader>
              ...
              <TableBody>
                {isLoadingState ? (
                  ...
                  prefixes.map((prefix) => (
                    <TableRow key={prefix.id} sx={styles.tableRowHover(theme)}>
                      <TableCell align="left">{prefix.id}</TableCell>
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={prefix.code} placement="top">
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={prefix.name} placement="top">
                          <span style={styles.cellContentStyles}>
                            {prefix.name}
                          </span>
                        </Tooltip>
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          <MenuItem
                            onClick={(e) =>
                              handleArchiveRestoreClick(prefix, e)
                            }>
                            {prefix.deleted_at ? (
                              <>
                  ...
                  <TableRow
                    ...
                    <TableCell
                      ...
                      <NoDataFound
                        ...
                        subMessage={
                          searchQuery
                            ? `No prefixes found for "${searchQuery}"`
