              ...
              <TableBody>
                {isLoadingState ? (
                  ...
                  cabinets.map((cabinet) => (
                    <TableRow key={cabinet.id} sx={styles.tableRowHover(theme)}>
                      <TableCell align="left">{cabinet.id}</TableCell>
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={cabinet.code} placement="top">
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={cabinet.name} placement="top">
                          <span style={styles.cellContentStyles}>
                            {cabinet.name}
                          </span>
                        </Tooltip>
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          <MenuItem
                            onClick={(e) =>
                              handleArchiveRestoreClick(cabinet, e)
                            }>
                            {cabinet.deleted_at ? (
                              <>
                  ...
                  <TableRow
                    ...
                    <TableCell
                      ...
                      <NoDataFound
                        ...
                        subMessage={
                          searchQuery
                            ? `No cabinets found for "${searchQuery}"`
