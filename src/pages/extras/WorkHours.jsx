                ...
                {isLoadingState ? (
                  ...
                  workHours.map((workHour) => (
                    <TableRow
                      ...
                      <TableCell align="left">{workHour.id}</TableCell>
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={workHour.code} placement="top">
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={workHour.name} placement="top">
                          <span style={styles.cellContentStyles}>
                            {workHour.name}
                          </span>
                        </Tooltip>
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          {!workHour.deleted_at && (
                            <MenuItem onClick={() => handleEditClick(workHour)}>
                  ...
                  <TableRow
                    ...
                    <TableCell
                      ...
                      <NoDataFound
                        ...
                        subMessage={
                          searchQuery
                            ? `No work hours found for "${searchQuery}"`
