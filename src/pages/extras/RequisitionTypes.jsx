      ...
      <Box
        ...
        <Box
          ...
          <Typography className="header">
            {isVerySmall ? "REQUISITIONS" : "REQUISITION TYPES"}
          </Typography>
                  ...
                  <TableCell
                    ...
                    <Box
                      ...
                      <Typography variant="h6" color="text.secondary">
                        No requisition types found
                      </Typography>
                      <Typography variant="body2" color="text.secondary">
                        {searchQuery
                          ? `No results for "${searchQuery}"`
                          : showArchived
                          ? "No archived requisition types"
                          : "No active requisition types"}
                      </Typography>
                    </Box>
                  </TableCell>
                </TableRow>
