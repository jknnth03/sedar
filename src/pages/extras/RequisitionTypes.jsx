...
const CustomSearchBar = ({
  ...
  return (
    <Box
      ...
      <TextField
        placeholder={isVerySmall ? "Search..." : "Search requisition types..."}
        value={searchQuery}
...
const RequisitionTypes = () => {
  ...
  const {
    ...
    refetch,
    error,
  } = useGetShowRequisitionsQuery(queryParams, {
  ...
  const handleMenuOpen = useCallback((event, requisition) => {
    event.stopPropagation();
    setMenuAnchor((prev) => ({
      ...prev,
      [requisition.id]: event.currentTarget,
    }));
  }, []);

  const handleMenuClose = useCallback((requisitionId) => {
    setMenuAnchor((prev) => ({ ...prev, [requisitionId]: null }));
  }, []);
  ...
  const handleArchiveRestoreClick = useCallback(
    (requisition, event) => {
      ...
      setConfirmOpen(true);
      handleMenuClose(requisition.id);
    },
    [handleMenuClose]
  );
  ...
  const handleAddRequisitionType = useCallback(() => {
    setSelectedRequisitionType(null);
    setModalOpen(true);
  }, []);
  ...
  const renderStatusChip = useCallback((requisition) => {
    const isActive = !requisition.deleted_at;
                ...
                {isLoadingState ? (
                  ...
                  requisitions.map((requisition) => (
                    <TableRow
                      ...
                      <TableCell align="left">{requisition.id}</TableCell>
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={requisition.code} placement="top">
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={requisition.name} placement="top">
                          <span style={styles.cellContentStyles}>
                            {requisition.name}
                          </span>
                        </Tooltip>
                      ...
                      {!isMobile && (
                        <TableCell align="center">
                          {renderStatusChip(requisition)}
                        </TableCell>
                      )}
                      <TableCell align="center">
                        <IconButton
                          onClick={(e) => handleMenuOpen(e, requisition)}
                          size="small">
                          <MoreVertIcon />
                        </IconButton>
                        <Menu
                          ...
                          onClose={() => handleMenuClose(requisition.id)}>
                          ...
                          <MenuItem
                            onClick={(e) =>
                              handleArchiveRestoreClick(requisition, e)
                            }>
                            {requisition.deleted_at ? (
                              <>
                  ...
                  <TableRow
                    ...
                    <TableCell
                      ...
                      <NoDataFound
                        ...
                        subMessage={
                          searchQuery
                            ? `No requisition types found for "${searchQuery}"`
                            : "No requisition types available"
                        }
                      />
                    </TableCell>
                  </TableRow>
