    ...
    <Box
      ...
      <TextField
        ...
        InputProps={{
          ...
          sx: {
            height: "36px",
            width: isVerySmall ? "100%" : isMobile ? "200px" : "320px",
...
const MovementTypes = () => {
  ...
  const movementTypeList = useMemo(
  ...
  const handleArchiveRestoreClick = useCallback(
    (movementType, event) => {
      ...
      console.log("Clicked archive/restore for:", movementType);
      ...
      <Box
        ...
        <Box
          ...
          <Typography className="header">
            {isVerySmall ? "MOVEMENT TYPES" : "MOVEMENT TYPES"}
          </Typography>
      ...
      <Box
                    ...
                    <Box
                      ...
                      <Typography variant="body2" color="text.secondary">
                        {searchQuery
                          ...
                          : showArchived
                          ? "No archived movement types"
                          : "No active movement types"}
                      </Typography>
                    </Box>
                  </TableCell>
                </TableRow>
        ...
        <Box
          ...
          <TablePagination
            ...
            component="div"
            count={movementTypes?.result?.total || 0}
