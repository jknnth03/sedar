...
const CustomSearchBar = ({
  ...
  return (
    <Box
      ...
      <TextField
        placeholder={isVerySmall ? "Search..." : "Search programs..."}
        value={searchQuery}
...
const Programs = () => {
  ...
  const {
    ...
    refetch,
    error,
  } = useGetShowProgramsQuery(queryParams, {
  ...
  const handleMenuOpen = useCallback((event, program) => {
    event.stopPropagation();
    setMenuAnchor((prev) => ({ ...prev, [program.id]: event.currentTarget }));
  }, []);

  const handleMenuClose = useCallback((programId) => {
  ...
  const renderStatusChip = useCallback((program) => {
    const isActive = !program.deleted_at;
              ...
              <TableBody>
                {isLoadingState ? (
                  ...
                  programs.map((program) => (
                    <TableRow key={program.id} sx={styles.tableRowHover(theme)}>
                      <TableCell align="left">{program.id}</TableCell>
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={program.code} placement="top">
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          <MenuItem
                            onClick={(e) =>
                              handleArchiveRestoreClick(program, e)
                            }>
                            {program.deleted_at ? (
                              <>
