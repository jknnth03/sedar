                ...
                {isLoadingState ? (
                  ...
                  workWeeks.map((workWeek) => (
                    <TableRow
                      ...
                      <TableCell align="left">{workWeek.id}</TableCell>
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={workWeek.code} placement="top">
                      ...
                      <TableCell sx={styles.formNameCell}>
                        <Tooltip title={workWeek.name} placement="top">
                          <span style={styles.cellContentStyles}>
                            {workWeek.name}
                          </span>
                        </Tooltip>
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          {!workWeek.deleted_at && (
                            <MenuItem onClick={() => handleEditClick(workWeek)}>
                  ...
                  <TableRow
                    ...
                    <TableCell
                      ...
                      <NoDataFound
                        ...
                        subMessage={
                          searchQuery
                            ? `No work weeks found for "${searchQuery}"`
                            : "No work weeks available"
                        }
                      />
                    </TableCell>
                  </TableRow>
