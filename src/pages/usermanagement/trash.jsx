...
//       // Validate Employee ID only when creating a new user
//       if (!selectedUser && !requestData.employee_id) {
//         enqueueSnackbar("Employee ID is required.", { variant: "error" });
//         return;
//       }

//       // Validate Role ID only when creating a new user
...
//             )}
//           </Grid>
//           {console.log("rolesssss😊😊", rolesData?.result)}
//           <Grid item xs={4}>
//             <Autocomplete
//               disablePortal
...
//               name="username"
//               value={
//                 selectedUser ? selectedUser.username : formData.username || ""
//               }
...
//               onChange={handleTextFieldChange}
//               onClick={() => {
//                 setIsEditing(true); // Enable editing when clicking the TextField
//                 setFormData((prev) => ({
//                   ...prev,
...
//               label="Unit"
//               value={
//                 selectedUser ? selectedUser.unit.unit_name : formData.unit || ""
//               }
//               disabled
//               sx={disabledStyle}
//             />
