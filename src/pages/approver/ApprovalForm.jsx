...
const ApprovalForm = () => {
  ...
  const handleArchiveRestoreConfirm = async () => {
    ...
    setIsLoading(true);
    try {
      await deleteApprovalForm(selectedForm.id).unwrap();
      enqueueSnackbar(
                ...
                {isLoadingState ? (
                  ...
                  approvalFormsList.map((form) => (
                    <TableRow
                      ...
                      {!isMobile && (
                        <TableCell sx={styles.formNameCell}>
                          <Tooltip title={form.code || "-"} placement="top">
                            <span style={styles.cellContentStyles}>
                              {form.code || "-"}
                            </span>
                          </Tooltip>
                      ...
                      <TableCell align="center">
                        ...
                        <Menu
                          ...
                          {!form.deleted_at && (
                            <MenuItem onClick={() => handleEditClick(form)}>
                  ...
                  <TableRow
                    ...
                    <TableCell
                      ...
                      <NoDataFound
                        ...
                        subMessage={
                          searchQuery
                            ? `No approval forms found for "${searchQuery}"`
                            : "No approval forms available"
                        }
                      />
                    </TableCell>
                  </TableRow>
      ...
      <Dialog
        ...
        <DialogContent>
          <Typography variant="body1" gutterBottom textAlign="center">
            ...
            <strong>{selectedForm?.deleted_at ? "restore" : "archive"}</strong>{" "}
            this approval form?
          </Typography>
          {selectedForm && (
            <Typography
