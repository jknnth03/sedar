...
import { useGetDataChangeReceiversQuery } from "../../features/api/approvalsetting/receiverApi";
import DataChangeReceivingTable from "./DataChangeReceivingTable";
import {
...
const DataChangeReceiving = () => {
  ...
  const {
    data: dataChangeData,
    isLoading: dataChangeLoading,
    isFetching: dataChangeFetching,
    refetch: refetchDataChange,
    error: dataChangeError,
  } = useGetDataChangeReceiversQuery(queryParams, {
  ...
  const isLoadingState = dataChangeLoading || dataChangeFetching;
        ...
        <Box
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.4 }}>
            <Typography className="header">
              {showReceived ? "RECEIVED DATA CHANGES" : "PENDING DATA CHANGES"}
            </Typography>
          </Box>
        ...
        <Box
          ...
          <Box
            ...
            <TablePagination
              ...
              component="div"
              count={dataChangeData?.result?.total || 0}
...
export default DataChangeReceiving;
