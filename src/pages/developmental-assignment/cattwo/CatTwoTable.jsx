            ...
            <TableRow sx={{ height: "100%" }}>
              <TableCell
                ...
                <Typography color="error">
                  {error?.data?.message || "Failed to load CAT 2 submissions"}
                </Typography>
              </TableCell>
            </TableRow>
              ...
              return (
                <TableRow
                  ...
                  <TableCell
                    ...
                    {submission?.employee?.position_title ||
                  ...
                  <TableCell
                    ...
                    {submission?.template?.name || submission?.name || "N/A"}
                  </TableCell>
                  <TableCell
                    sx={{
