...
const PdpApproved = ({ searchQuery, dateFilters, onRowClick, onCancel }) => {
  ...
  const handleActionConfirm = async () => {
    ...
    try {
      if (confirmAction === "cancel" && selectedSubmissionForAction) {
        ...
        enqueueSnackbar("PDP approved submission cancelled successfully!", {
          variant: "success",
          autoHideDuration: 2000,
        });
        refetch();
  ...
  const getConfirmationMessage = useCallback(() => {
    if (confirmAction === "cancel") {
      return (
        <>
          Are you sure you want to <strong>Cancel</strong> this Approved PDP
          Submission?
        </>
      );
    }
