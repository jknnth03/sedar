...
const Municipalities = () => {
  ...
  const isLoadingState =
    onerdfFetching || fetchingMunicipalities || isSearching || syncing;
      ...
      <Box
        ...
        <Box
          ...
          <Box
            ...
            <Typography className="header">
              {isVerySmall ? "MUNICIPALITIES" : "MUNICIPALITIES"}
            </Typography>
        ...
        <Box
          ...
          <TableContainer
            ...
            <Table stickyHeader sx={{ minWidth: isMobile ? 350 : 1000 }}>
              <TableHead>
                <TableRow>
                  <TableCell
                    align="left"
                  ...
                  {!isVerySmall && !isMobile && (
                    <TableCell sx={{ width: "150px" }}>PSGC CODE</TableCell>
                  )}
                  ...
                  {!isVerySmall && (
                    <TableCell
                      sx={{ width: isMobile ? "60px" : "150px" }}
                      align="center">
                      SUB-MUN
                    </TableCell>
                  )}
                  <TableCell
                    sx={{ width: isMobile ? "60px" : "120px" }}
                    align="center">
                    BARANGAY
                  </TableCell>
                </TableRow>
              ...
              <TableBody>
                {isLoadingState ? (
                  <TableRow>
                    <TableCell
                      colSpan={isVerySmall ? 3 : isMobile ? 4 : 5}
                      align="center"
                      sx={{ py: 4 }}>
                      <CircularProgress
                        size={32}
                      ...
                      {!isVerySmall && !isMobile && (
                        <TableCell
                          ...
                          <Tooltip title={municipality.psgc_id} placement="top">
                            <span>{municipality.psgc_id}</span>
                          </Tooltip>
                        </TableCell>
                      )}
                      <TableCell
