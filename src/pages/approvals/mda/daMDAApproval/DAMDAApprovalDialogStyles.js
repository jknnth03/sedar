...
export const titleIconBoxStyles = {
  display: "flex",
  alignItems: "center",
  gap: 1,
};
...
export const fieldRowStyles = {
  display: "flex",
  gap: 6,
  mb: 1.5,
};

export const fieldRowLastStyles = {
  display: "flex",
  gap: 6,
};
...
export const descriptionValueStyles = {
  color: "#000000ff",
  fontSize: "13px",
  whiteSpace: "pre-wrap",
...
export const skeletonFieldBoxStyles = {
  flex: 1,
  minHeight: "60px",
};

export const skeletonTextStyles = {
  mb: 0.5,
};
