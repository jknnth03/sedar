...
const MDAEvaluationApprovalDialog = ({
  open,
  onClose,
  approval,
  onApprove = () => {},
    ...
    <>
      <Dialog
        ...
        <DialogContent>
          {isLoadingData ? (
            <>
              {renderSkeletonSection("Employee Information", 4)}
              ...
              {isProcessed && (
                <Box sx={styles.processedBoxStyles}>
                  <Typography
                    ...
                    This MDA Evaluation request has already been {status}
                  </Typography>
                </Box>
              )}
            </>
      ...
      <Dialog
        ...
        <DialogContent sx={styles.confirmContentStyles}>
          <Typography
            ...
            {confirmAction === "approve"
              ? "Are you sure you want to Approve this MDA Evaluation request?"
              : "Are you sure you want to Reject this MDA Evaluation request?"}
          </Typography>
          <Typography
            variant="body2"
            color="text.secondary"
            sx={styles.confirmIdStyles}>
            MDA Evaluation Request ID: {approval?.id || "N/A"}
          </Typography>
...
export default MDAEvaluationApprovalDialog;
