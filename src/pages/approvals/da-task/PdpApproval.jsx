...
const TabPanel = ({ children, value, index, ...other }) => {
  return (
    <div
      role="tabpanel"
      hidden={value !== index}
      id={`pdp-approval-tabpanel-${index}`}
      aria-labelledby={`pdp-approval-tab-${index}`}
      style={{
        height: "100%",
        overflow: "hidden",
        minWidth: 0,
...
const PdpApproval = () => {
  ...
  const a11yProps = (index) => {
    return {
      id: `pdp-approval-tab-${index}`,
      "aria-controls": `pdp-approval-tabpanel-${index}`,
    };
  };
