...
} from "../../../features/api/assessment-template/pdpTemplateApi";
import PdpTemplateFields from "./PdpTemplateModalFields";
...
const PdpTemplateModal = ({
  ...
  const { data: templateData, isLoading: isLoadingTemplate } =
    useGetPdpTemplateByIdQuery(templateId, {
  ...
  const getModalTitle = () => {
    const titles = {
      create: "CREATE PDP TEMPLATE",
      view: "VIEW PDP TEMPLATE",
      edit: "EDIT PDP TEMPLATE",
    };
    return titles[currentMode] || "PDP Template";
  };
...
export default PdpTemplateModal;
