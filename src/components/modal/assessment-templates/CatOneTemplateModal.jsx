...
import CatOneTemplateFields from "./CatOneTemplateModalFields";
...
const CatOneTemplateModal = ({
  ...
  const { data: templateData, isLoading: isLoadingTemplate } =
    useGetCatOneTemplateByIdQuery(templateId, {
  ...
  const getModalTitle = () => {
    const titles = {
      create: "CREATE CAT I TEMPLATE",
      view: "VIEW CAT I TEMPLATE",
      edit: "EDIT CAT I TEMPLATE",
    };
    return titles[currentMode] || "CAT I Template";
  };
  ...
  const formKey = `cat-one-template-${
    open ? "open" : "closed"
...
export default CatOneTemplateModal;
