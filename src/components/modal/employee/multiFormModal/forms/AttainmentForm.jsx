  ...
  (
    ...
    useEffect(() => {
      if (
        ...
        console.log("Initializing form with attainment data:", attainmentData); // Debug log
        ...
        // FIXED: Handle existing attachment properly
        // Store attachment info for view mode, but keep form field as null for new uploads
        ...
        console.log("Attachment filename:", attachmentFilename); // Debug log
        console.log("Attachment URL:", attachmentUrl); // Debug log

        // For view mode, we don't set the file object, but we track the filename/url
        setValue("attainment_attachment", null);

        // Store attachment metadata separately if needed
    ...
    // Reset initialization flag for create mode
    useEffect(() => {
      if (mode === "create") {
