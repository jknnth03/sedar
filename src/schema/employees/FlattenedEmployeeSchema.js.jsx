...
export const createFlattenedEmployeeSchema = () => {
  return yup.object().shape({
    ...
    additional_tools: yup.string().nullable(),
    additional_rate_remarks: yup.string().nullable(),
    schedule_id: yup
      .object()
      .shape({ id: yup.string(), name: yup.string() })
      .transform(transformObjectField)
    ...
    bank: yup
      ...
      .test("bank-format", "Bank must be a valid object", function (value) {
      ...
      yup.object().shape({
        file_type_id: yup
          ...
          .test(
            ...
            "File type is required when file cabinet is selected",
            function (value) {
              const { file_cabinet_id } = this.parent || {};
              if (file_cabinet_id !== null && file_cabinet_id !== undefined) {
        ...
        file_cabinet_id: yup
          ...
          .test(
            "conditional-required",
            "File cabinet is required when file type is selected",
            function (value) {
              const { file_type_id } = this.parent || {};
              if (file_type_id !== null && file_type_id !== undefined) {
                return value !== null && value !== undefined;
              }
              return true;
            }
...
// Step validation function - single source of truth
